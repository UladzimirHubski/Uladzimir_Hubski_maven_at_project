...
public class Email_Create {
    ...
    private final static String PAGE = BookingInputR.FakeEmail;
    ...
    public void Input_Name() {
        ...
        make.doubleClick(driver.findElement(By.xpath(NAMEFIELD))).sendKeys(BookingInputR.TrashEmail).perform();
    }

    public void Input_PersonalEmail() {
        driver.findElement(By.xpath(PSWDFIELD)).sendKeys(BookingInputR.PersonalEmail);
    }
